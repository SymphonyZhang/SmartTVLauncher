...
import com.tv.gamelauncher.BrowseErrorActivity;
import com.tv.gamelauncher.DetailsActivity;
import com.tv.gamelauncher.Movie;
import com.tv.gamelauncher.R;
import com.tv.gamelauncher.model.App;
import com.tv.gamelauncher.presenter.AppCardPresenter;
...
public class MainFragment extends BrowseFragment {
    ...
    private void loadRows() {
        ...
        //Create a row for apps
        HeaderItem appHeader = new HeaderItem("Apps");
        AppCardPresenter appCardPresenter = new AppCardPresenter();
        ArrayObjectAdapter listRowAdapter = new ArrayObjectAdapter(appCardPresenter);
        List<App> apps = Utils.getLaunchAppList(getActivity());
        Log.d(TAG, "onLoadFinished: ---------------------------------------apps.size() = "+apps.size());
        for (App app : apps){
            listRowAdapter.add(app);
        }
        mRowsAdapter.add(new ListRow(appHeader,listRowAdapter));
    ...
    private void setupUIElements() {
        setTitle(Utils.getTime(getActivity()));
