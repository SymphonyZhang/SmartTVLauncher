...
/**
 * Created by Francis on 2016/8/7.
 */
...
public class SearchOrbView extends FrameLayout implements View.OnClickListener {
    ...
    public SearchOrbView(Context context, AttributeSet attrs) {
        this(context, attrs, android.support.v17.leanback.R.attr.searchOrbViewStyle);
    }
    ...
    public SearchOrbView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mSearchOrbView = mRootView.findViewById(android.support.v17.leanback.R.id.search_orb);
        mIcon = (ImageView) mRootView.findViewById(android.support.v17.leanback.R.id.icon);

        mFocusedZoom = context.getResources().getFraction(
                android.support.v17.leanback.R.fraction.lb_search_orb_focused_zoom, 1, 1);
        mPulseDurationMs = context.getResources().getInteger(
                android.support.v17.leanback.R.integer.lb_search_orb_pulse_duration_ms);
        mScaleDurationMs = context.getResources().getInteger(
                android.support.v17.leanback.R.integer.lb_search_orb_scale_duration_ms);
        mFocusedZ = context.getResources().getDimensionPixelSize(
                android.support.v17.leanback.R.dimen.lb_search_orb_focused_z);
        mUnfocusedZ = context.getResources().getDimensionPixelSize(
                android.support.v17.leanback.R.dimen.lb_search_orb_unfocused_z);

        TypedArray a = context.obtainStyledAttributes(attrs, android.support.v17.leanback.R.styleable.lbSearchOrbView,
                defStyleAttr, 0);

        Drawable img = a.getDrawable(android.support.v17.leanback.R.styleable.lbSearchOrbView_searchOrbIcon);
        if (img == null) {
            img = res.getDrawable(android.support.v17.leanback.R.drawable.lb_ic_in_app_search);
        }
        setOrbIcon(img);

        int defColor = res.getColor(android.support.v17.leanback.R.color.lb_default_search_color);
        int color = a.getColor(android.support.v17.leanback.R.styleable.lbSearchOrbView_searchOrbColor, defColor);
        int brightColor = a.getColor(
                android.support.v17.leanback.R.styleable.lbSearchOrbView_searchOrbBrightColor, color);
        int iconColor = a.getColor(android.support.v17.leanback.R.styleable.lbSearchOrbView_searchOrbIconColor, Color.TRANSPARENT);
    ...
    int getLayoutResourceId() {
        return android.support.v17.leanback.R.layout.lb_search_orb;
    }
    ...
    public void setOrbColor(int color) {
        setOrbColors(new android.support.v17.leanback.widget.SearchOrbView.Colors(color, color, Color.TRANSPARENT));
    }

    /**
     * Sets the search orb colors.
     * Other colors are provided by the framework.
     * @deprecated Use {@link #setOrbColors(android.support.v17.leanback.widget.SearchOrbView.Colors)} instead.
     */
    @Deprecated
    public void setOrbColor(@ColorInt int color, @ColorInt int brightColor) {
        setOrbColors(new android.support.v17.leanback.widget.SearchOrbView.Colors(color, brightColor, Color.TRANSPARENT));
    }
    ...
    /**
     * Sets the {@link android.support.v17.leanback.widget.SearchOrbView.Colors} used to display the search orb.
     */
    ...
    /**
     * Returns the {@link android.support.v17.leanback.widget.SearchOrbView.Colors} used to display the search orb.
     */
